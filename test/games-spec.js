...
describe('Steam games api', function(){
  ...
  it('should get array of owned games', function(done){
  ...
  it('should receive some more owned games', function(done){
    var offset = 30;
    request
      .get(SERVER + '/saved')
      .query({"offset": offset})
  ...
  it('should receive exactly 2 games', function(done){
    request
      .get(SERVER + '/saved')
  ...
  it('should skip the first game when offset is 1', function(done){
